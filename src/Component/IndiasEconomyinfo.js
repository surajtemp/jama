...
import undrawtransfermoneyeconomy from '../assets/undraw_transfer_money_economy.svg';
                        ...
                        <div class="row valign-wrapper">
                            <div class="col s12 m12 push-m6">
                                <div class="Aboutus-img-right right-align">
                                    <img class=" responsive-img" src={undrawtransfermoneyeconomy} />
                                </div>
                            </div>
                            <div class="col s12 m12 pull-m6">
                                <div class="about-philosophy-left-content">
                                    <h4>India's $5 Trillion Economy</h4>
