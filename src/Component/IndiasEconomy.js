            ...
            <div class="row">
              <div class="col s3 m4 xl3 tab-card-margin-style">
                ...
                <div class="left-menu-sub-tabs">
                  <div class="Jama-tab-card-btn left-menu-sub-tabs-below-wealth b-rad-t left-menu-sub-active">
                    <span>
                  ...
                  <Link to="/HowtoAlocate">  <div class="Jama-tab-card-btn left-menu-sub-tabs-below-wealth b-t-1 b-rad-b">
                    <span>
